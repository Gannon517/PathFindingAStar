...
def algorithm(draw, grid, start, end):
    ...
    last_node = {}
    g_score = {spot: float("inf") for row in grid for spot in row} #keeps track of shortest distance 
    g_score[start] = 0
    f_score = {spot: float("inf") for row in grid for spot in row} #keeps track of predicted distance
    ...
    while not open_set.empty():
        ...
        for neighbor in current.neighbors:
            ...
            if temp_g_score < g_score[neighbor]:
                ...
                f_score[neighbor] = temp_g_score + manhatten(neighbor.get_pos(), end.get_pos())
